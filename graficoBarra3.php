...
<form action="graficoBarra3.php" method="post" id="form" class="form-md">
...
<?php
    ...
    $sql="SELECT CASE WHEN respuesta3 = 1 THEN respuesta3 / 1
                      WHEN respuesta3 = 2 THEN respuesta3 / 2
                      WHEN respuesta3 = 3 THEN respuesta3 / 3
                      WHEN respuesta3 = 4 THEN respuesta3 / 4
                      WHEN respuesta3 = 5 THEN respuesta3 / 5 end as respuestatres,
    respuesta3 
