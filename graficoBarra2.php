...
<form action="graficoBarra2.php" method="post" id="form" class="form-md">
...
<?php
    ...
    $sql="SELECT CASE WHEN respuesta2 = 1 THEN respuesta2 / 1
                      WHEN respuesta2 = 2 THEN respuesta2 / 2
                      WHEN respuesta2 = 3 THEN respuesta2 / 3
                      WHEN respuesta2 = 4 THEN respuesta2 / 4
                      WHEN respuesta2 = 5 THEN respuesta2 / 5 end as respuestados,
    respuesta2 
